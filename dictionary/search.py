...
DICTIONARIES: dict[str, DictionaryConfig] = {
    "de-es": DictionaryConfig(
        id="de-es",
        database_path=DATA_DIR / "de-es-dictionary.sqlite",
    ...
    "en-es": DictionaryConfig(
        id="en-es",
        database_path=DATA_DIR / "en-es-dictionary.sqlite",
        gloss_lookup_dictionary_id="es-en",
        title="Diccionario inglés-español",
        description="Buscador FastAPI + SQLite para el diccionario inglés-español.",
        direction_label="Inglés -> español",
        search_label="Palabra en inglés",
        placeholder="Ej. house, dictionary, run, weather",
        examples=(
            "house",
            "dictionary",
            "run",
    ...
    "es-en": DictionaryConfig(
        id="es-en",
        database_path=DATA_DIR / "es-en-dictionary.sqlite",
        gloss_lookup_dictionary_id="en-es",
        title="Diccionario español-inglés",
        description="Buscador FastAPI + SQLite para el diccionario español-inglés.",
        direction_label="Español -> inglés",
        search_label="Palabra en español",
        placeholder="Ej. casa, diccionario, correr, tiempo",
        examples=(
            "casa",
            "diccionario",
            "correr",
